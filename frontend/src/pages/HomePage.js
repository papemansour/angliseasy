              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-blue-900 mb-1">Paiement Sécurisé</p>
                      <p className="text-xs text-blue-800">
                        Stripe est un fournisseur de services PCI certifié de niveau 1, le niveau de certification le plus rigoureux du secteur des paiements. 
                        Votre carte est débitée lorsque vous réservez un service.
                      </p>
                    </div>
                  </div>
                </div>
