...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 md:py-20 px-4 bg-gradient-to-b from-white to-teal-50">
        <div className="container mx-auto max-w-7xl">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-3 md:mb-6 text-teal-800">
            Fonctionnalités principales développées
          </h2>
          <p className="text-center text-gray-600 mb-8 md:mb-12 max-w-3xl mx-auto">
            Une plateforme complète avec des outils avancés pour une expérience d'apprentissage optimale
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-lg mb-2 text-teal-700">Système de Notifications</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Icône avec compteur de notifications</li>
                <li>• Messages, documents, liens, devoirs</li>
                <li>• Vérification automatique toutes les 30s</li>
                <li>• Marquage "lu" à la sélection</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-lg mb-2 text-teal-700">Gestion des Utilisateurs</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Suppression professeurs et étudiants</li>
                <li>• Suppression complète des données</li>
                <li>• Protection des administrateurs</li>
                <li>• Gestion des restrictions d'accès</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">✉️</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Messages Administratifs</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Envoi à plusieurs destinataires</li>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">🔒</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Restriction d'Accès</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Basée sur retards ou comportements</li>
                <li>• Blocage de connexion temporaire</li>
                <li>• Gestion flexible par l'admin</li>
                <li>• Notifications automatiques</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">🔐</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Sécurité Renforcée</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Changement de mot de passe sécurisé</li>
                <li>• Réinitialisation par l'admin</li>
                <li>• Hash cryptographique bcrypt</li>
                <li>• Mots de passe temporaires</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">📰</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Onglet Actualités</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Consultation dans tous les dashboards</li>
                <li>• Publication par admin</li>
                <li>• Notifications automatiques</li>
                <li>• Support vidéos et liens</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">📇</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Annuaire Complet</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Liste complète des inscrits</li>
                <li>• Affichage des informations</li>
                <li>• Contact direct possible</li>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">📅</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Disponibilités Profs</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Choix des jours et heures</li>
                <li>• Visualisation par l'admin</li>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition">
              <div className="text-3xl mb-3">🔧</div>
              <h3 className="font-bold text-lg mb-2 text-teal-700">Infrastructure Robuste</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• 13+ routes API backend</li>
                <li>• Collections MongoDB optimisées</li>
