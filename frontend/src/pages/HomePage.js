        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative overflow-hidden rounded-2xl border-2 border-teal-200 bg-white/60 backdrop-blur-lg hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                <div className="text-center mb-6">
                  <div className="text-gray-400 line-through text-xl">80€ / 52 476 FCFA</div>
                  <div className="text-4xl font-bold text-teal-600">76€</div>
                  <div className="text-2xl font-semibold text-teal-700">49 853 FCFA</div>
            ...
            <div className="relative overflow-hidden rounded-2xl border-2 border-teal-300 bg-white/60 backdrop-blur-lg hover:shadow-xl transition-all transform hover:scale-105">
              ...
              <div className="p-6">
                <div className="text-center mb-6">
                  <div className="text-gray-400 line-through text-xl">100€ / 65 596 FCFA</div>
                  <div className="text-4xl font-bold text-teal-600">90€</div>
                  <div className="text-2xl font-semibold text-teal-700">59 036 FCFA</div>
